...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 2, 8, 213);
    			attr_dev(div1, "class", "text-sm md:text-3xl lowercase");
    			add_location(div1, file, 3, 8, 281);
    			attr_dev(div2, "class", "flex flex-row items-baseline font-Righteous text-rc-orange");
    			add_location(div2, file, 1, 4, 131);
    			attr_dev(header, "class", "absolute inset-0 flex justify-center items-center w-full h-header md:h-2header bg-rc-blue-dark shadow-bottom");
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, ImageBox });
    	return [];
    }
