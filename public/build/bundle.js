    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 8, 12, 379);
    			attr_dev(div1, "class", "m-4 justify-self-center shadow-bottom h-027 w-019 md:h-031 md:w-021");
    			add_location(div1, file$1, 7, 8, 284);
    		},
    		m: function mount(target, anchor) {
