...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 8, 12, 321);
    			attr_dev(div1, "class", "m-4 shadow-bottom h-012 w-08 md:h-031 md:w-021");
    			add_location(div1, file$1, 7, 8, 247);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "grid grid-cols-2 md:grid-cols-3 p-8");
    ...
    const file$3 = "src\\app\\views\\Home.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 7, 0, 226);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			insert_dev(target, div, anchor);
    			mount_component(imagebox, div, null);
