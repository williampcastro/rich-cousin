...
var app = (function () {
    ...
    const file$1 = "src/app/components/footer/Footer.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(footer, file$1, 6, 0, 162);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src/app/components/imageBox/ImageBox.svelte";
    ...
    // (21:4) {#each imageNames as imageName}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			t = space();
    			attr_dev(div, "class", "hover:shadow-2xl h-full");
    			set_style(div, "background-image", "url(" + /*basePath*/ ctx[1] + /*imageName*/ ctx[5] + /*typeImage*/ ctx[0] + ")");
    			set_style(div, "background-size", "cover");
    			add_location(div, file$2, 22, 12, 722);
    			attr_dev(a, "href", a_href_value = "" + (/*basePath*/ ctx[1] + /*imageName*/ ctx[5] + /*typeImage*/ ctx[0]));
    			attr_dev(a, "class", "m-4 justify-self-center shadow-bottom h-026 w-018");
    			add_location(a, file$2, 21, 8, 585);
    		},
    		m: function mount(target, anchor, remount) {
    			...
    			append_dev(a, t);
    			if (remount) dispose();
    			dispose = listen_dev(a, "click", handleClick, false, false, false);
    		},
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*typeImage*/ 1 && a_href_value !== (a_href_value = "" + (/*basePath*/ ctx[1] + /*imageName*/ ctx[5] + /*typeImage*/ ctx[0]))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(21:4) {#each imageNames as imageName}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-4 md:p-8 parent-div");
    			add_location(div, file$2, 19, 0, 443);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*basePath, imageNames, typeImage, handleClick*/ 7) {
    ...
    function handleClick() {
    	jquery(".parent-div").magnificPopup({
    		delegate: "a",
    		type: "image",
    ...
    class ImageBox extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { path: 3, typeImage: 0, totalImages: 4 });
    ...
    const file$3 = "src/app/components/titleChallange/TitleChallenge.svelte";
    ...
    /* src/app/components/challenge/Challenge.svelte generated by Svelte v3.21.0 */
    const file$4 = "src/app/components/challenge/Challenge.svelte";
    ...
    // (12:4) {#each challenges as challenge}
    function create_each_block$1(ctx) {
    	let t;
    	let current;

    	const titlechallenge = new TitleChallenge({
    			props: { title: /*challenge*/ ctx[1].title },
    			$$inline: true
    		});

    	const imagebox = new ImageBox({
    			props: {
    				path: /*challenge*/ ctx[1].image.path,
    				typeImage: /*challenge*/ ctx[1].image.type,
    				totalImages: /*challenge*/ ctx[1].image.total
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			create_component(titlechallenge.$$.fragment);
    			t = space();
    			create_component(imagebox.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(titlechallenge, target, anchor);
    			insert_dev(target, t, anchor);
    			mount_component(imagebox, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const titlechallenge_changes = {};
    			if (dirty & /*challenges*/ 1) titlechallenge_changes.title = /*challenge*/ ctx[1].title;
    			titlechallenge.$set(titlechallenge_changes);
    			const imagebox_changes = {};
    			if (dirty & /*challenges*/ 1) imagebox_changes.path = /*challenge*/ ctx[1].image.path;
    			if (dirty & /*challenges*/ 1) imagebox_changes.typeImage = /*challenge*/ ctx[1].image.type;
    			if (dirty & /*challenges*/ 1) imagebox_changes.totalImages = /*challenge*/ ctx[1].image.total;
    			imagebox.$set(imagebox_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(titlechallenge.$$.fragment, local);
    			transition_in(imagebox.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(titlechallenge.$$.fragment, local);
    			transition_out(imagebox.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(titlechallenge, detaching);
    			if (detaching) detach_dev(t);
    			destroy_component(imagebox, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(12:4) {#each challenges as challenge}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	let div;
    	let current;
    	let each_value = /*challenges*/ ctx[0];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 9, 0, 180);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*challenges*/ 1) {
    				each_value = /*challenges*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["challenges"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Challenge> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$set = $$props => {
    		if ("challenges" in $$props) $$invalidate(0, challenges = $$props.challenges);
    	};

    	$$self.$capture_state = () => ({ ImageBox, TitleChallenge, challenges });
    ...
    class Challenge extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { challenges: 0 });
    		...
    		if (/*challenges*/ ctx[0] === undefined && !("challenges" in props)) {
    			console.warn("<Challenge> was created without expected prop 'challenges'");
    		}
    	}

    	get challenges() {
    		throw new Error("<Challenge>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set challenges(value) {
    		throw new Error("<Challenge>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	const challenge = new Challenge({
    			props: { challenges: /*challenges*/ ctx[0] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(challenge, target, anchor);
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(challenge, detaching);
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	const getDefaultObjectOfChallenge = () => {
    		return {
    			title: null,
    			image: { path: null, type: null, total: null }
    		};
    	};
